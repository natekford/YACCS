...
public class CommandTrie_Tests
{
	...
	public void AddAndRemove_Test()
	{
		...
		Assert.AreEqual(1, _Trie.Root["1"].GetItems(true).ToHashSet().Count);
		...
		Assert.AreEqual(1, _Trie.Root["2"].GetItems(true).ToHashSet().Count);
		Assert.AreEqual(1, _Trie.Root["2"].Count);
		Assert.AreEqual(1, _Trie.Root["3"].GetItems(true).ToHashSet().Count);
		...
		Assert.AreEqual(1, _Trie.Root["4"].GetItems(true).ToHashSet().Count);
		Assert.AreEqual(0, _Trie.Root["4"].Count);
		Assert.AreEqual(1, _Trie.Root["4"]["1"].GetItems(true).ToHashSet().Count);
		Assert.AreEqual(1, _Trie.Root["4"]["2"].GetItems(true).ToHashSet().Count);
		Assert.AreEqual(1, _Trie.Root["4"]["3"].GetItems(true).ToHashSet().Count);
		...
		Assert.AreEqual(4, _Trie.Root.Edges.Count);
		Assert.AreEqual(2, _Trie.Root["4"].GetItems(true).ToHashSet().Count);
		Assert.AreEqual(0, _Trie.Root["4"].Count);
		Assert.AreEqual(2, _Trie.Root["4"]["1"].GetItems(true).ToHashSet().Count);
		Assert.AreEqual(1, _Trie.Root["4"]["2"].GetItems(true).ToHashSet().Count);
		Assert.AreEqual(1, _Trie.Root["4"]["3"].GetItems(true).ToHashSet().Count);
		...
		Assert.AreEqual(1, _Trie.Root["5"].GetItems(true).ToHashSet().Count);
	...
	public void Duplicate_Test()
	{
		...
		_Trie.Add(c1);
		Assert.AreEqual(1, _Trie.Count);
		Assert.AreEqual(1, _Trie.Root["a"].GetItems(true).ToHashSet().Count);
		...
		_Trie.Add(c3);
		Assert.AreEqual(3, _Trie.Count);
		Assert.AreEqual(1, _Trie.Root["b"].GetItems(true).ToHashSet().Count);
		...
		_Trie.Add(c4);
		Assert.AreEqual(4, _Trie.Count);
		Assert.AreEqual(3, _Trie.Root["a"].GetItems(true).ToHashSet().Count);
		...
		Action<HashSet<IImmutableCommand>>? assert = null)
	{
		...
		var found = node!.GetItems(true).ToHashSet();
